...
let summary = "microservices platfrom"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "microservices platform"

// List of author names (for NuGet package)
let author = "Ryan Britton"

// Tags for your project (for NuGet package)
let tags = "F# microservices event-driven eventsourcing cqrs event-streaming"

// File system information
let solutionFile  = "mosaic.sln"
...
let gitOwner = "ryan.britton@mint.co.za"
let gitHome = sprintf "%s/%s" "https://github.com/RealRyanBritton/mosaic" gitOwner

// The name of the project on GitHub
let gitName = "mosaic"

// The url for the raw files hosted
let gitRaw = Environment.environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/RealRyanBritton/mosaic/ryan.britton@mint.co.za"
...
let info =
  [ "project-name", "mosaic"
    "project-author", "Ryan Britton"
    "project-summary", "microservices platfrom"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/mosaic" ]
